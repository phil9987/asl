...
TIMEOUT 5
start cmd /k ssh -p 2222 osboxes@localhost -t "cd memtier_benchmark ; ./memtier_benchmark -p 1234 -n 1000 --protocol=memcache_text -c 1 -x 1 -t 1 -D --ratio=1:1 --data-size=9000 ; /bin/bash"
