...
screen -L -dm -S server3 "ssh -o StrictHostKeyChecking=no junkerp@${server3} 'memcached -p 11212 -vv'"
# start middleware1
screen -L -dm -S middleware1 "ssh -o StrictHostKeyChecking=no junkerp@${MW1} 'cd asl; java -jar dist/middleware-junkerp.jar  -l ${MW1} -p 1234 -t 2 -s true -m ${server1}:11212 ${server2}:11212 ${server3}:11212'"
