...
cmd="ssh junkerp@${client1} 'cd memtier_benchmark ; ./memtier_benchmark --server=${MW1} --port=11212 --clients=1 --requests=10000 --protocol=memcache_text --run-count=1 --threads=1 --debug --key-maximum=10000 --ratio=1:0 --data-size=4096 --key-pattern=S:S'"
#run the command
echo $cmd
$cmd
