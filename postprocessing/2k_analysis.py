...
def calcAndAddEffects(dataframe, cols, SSE):
    ...
    lastcol_data.append('-')
    lastcol_data.append('-')
    df = pd.DataFrame([lastcol_data], columns=cols)
    dataframe = dataframe.append(df)

    varEffectCol.append('-')
    df = pd.DataFrame([varEffectCol], columns=cols)
    return dataframe.append(df)

def generate2kTables(basefolder):
    sseThroughput = 0.0
    sseLatency = 0.0
...
print("READONLY\n-------------------------------------")
generate2kTables('C:/Users/philip/Programming/AdvancedSystemsLab/Programming/data/experiment_logs_09-12-2018_20-57-05/logSection6a/')
print("WRITEONLY\n-------------------------------------")
generate2kTables('C:/Users/philip/Programming/AdvancedSystemsLab/Programming/data/experiment_logs_09-12-2018_20-57-05/logSection6b/')
