...
for w, serviceRate in workerServicerates:
    ...
    for cli in clients:
        ...
        print('meanThroughput={} serviceRate={} traffic intensity = {}'.format(meanClientThroughput, serviceRate, p))
        predictedResponseTime = (1/serviceRate)/(1-p)*1000
        print("W{}C{} observed RT = {} predicted RT = {}".format(w, cli*6, meanClientResponseTime*1000, predictedResponseTime))
        predictedQueueLen = (p*p)/(1-p)
        print("W{}C{} observed NQ = {} predicted NQ = {}".format(w, cli*6, meanQueueLen, predictedQueueLen))
        predictedWaitingTime = p*(1/serviceRate)/(1-p)*(1000)
...
writeToFile(output, './plots/MM1tables.tex')
...
plot_generic(xs, queueLenPred, 
             ...
             xticks=x, 
             ymax=460,
             save_file='7_MM1_QueueSizePred.eps')
plot_generic(xs, queueLenObs, 
             ...
             xticks=x, 
             ymax=460,
             save_file='7_MM1_QueueSizeObserved.eps')
...
plot_generic(xs, responseTimeObs, 
             ...
             xticks=x, 
             ymax=70,
             save_file='7_MM1_ResponseTimeObserved.eps')
plot_generic(xs, responseTimePred, 
             ...
             xticks=x, 
             ymax=70,
             save_file='7_MM1_ResponseTimePredicted.eps')
...
plot_generic(xs, waitingTimeObs, 
             ...
             xticks=x, 
             ymax=65,
             save_file='7_MM1_WaitingTimeObserved.eps')
plot_generic(xs, responseTimePred, 
             ...
             xticks=x, 
             ymax=65,
             save_file='7_MM1_WaitingTimePredicted.eps')
